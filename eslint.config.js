...
function ConfigOptions() {
  ...
  LinterOptions.ts = LinterOptions.js;
...
const BaseConfig = {
  js: {
    files: ConfigOptions().Files.js,
    plugins: ConfigOptions().Plugins.js,
    linterOptions: ConfigOptions().LinterOptions.js,
    languageOptions: ConfigOptions().LanguageOptions.js,
  },
  ts: {
    files: ConfigOptions().Files.ts,
    plugins: ConfigOptions().Plugins.ts,
    linterOptions: ConfigOptions().LinterOptions.ts,
    languageOptions: ConfigOptions().LanguageOptions.ts,
  },
};
...
RuleSets.ts = {
  // Presets
  functionalPreset: { ...tsLint.configs["eslint-recommended"].rules },
  stylisticPreset: { ...stylistic.configs["disable-legacy"].rules },

  // Custom: ESLint extensions for TypeScript
...
export default [
  ...FlattenRulesets(BaseConfig.js, RuleSets.js),
  ...FlattenRulesets(BaseConfig.ts, RuleSets.ts),
];
